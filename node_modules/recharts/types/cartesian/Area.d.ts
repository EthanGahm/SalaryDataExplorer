...
import { D3Scale, LegendType, TooltipType, AnimationTiming, ChartOffset, Coordinate, DataKey, TickItem } from 'recharts/types/util/types';
...
export declare type Props = Omit<SVGProps<SVGElement>, 'type'> & AreaProps;
interface State {
