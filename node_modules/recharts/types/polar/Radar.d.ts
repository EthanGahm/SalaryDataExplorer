...
import { LegendType, TooltipType, AnimationTiming, DataKey } from 'recharts/types/util/types';
...
export declare class Radar extends PureComponent<Props, State> {
    ...
    static getComposedData: ({ radiusAxis, angleAxis, displayedData, dataKey, bandSize, }: {
        radiusAxis: React.AriaAttributes & import("recharts/types/util/types").DOMAttributesAdaptChildEvent<any, SVGElement> & Omit<React.SVGProps<SVGElement>, keyof import("recharts/types/util/types").DOMAttributesAdaptChildEvent<P, T>> & import("recharts/types/polar/PolarRadiusAxis").PolarRadiusAxisProps & {
            scale: (value: any) => number;
        };
        angleAxis: React.AriaAttributes & import("recharts/types/util/types").DOMAttributesAdaptChildEvent<any, SVGTextElement> & Omit<React.SVGProps<SVGTextElement>, keyof import("recharts/types/util/types").DOMAttributesAdaptChildEvent<P, T>> & import("recharts/types/polar/PolarAngleAxis").PolarAngleAxisProps & {
            scale: (value: any) => number;
        };
        displayedData: any[];
