...
export declare const ComposedChart: {
    new (props: import("recharts/types/chart/generateCategoricalChart").CategoricalChartProps): {
        ...
        verticalCoordinatesGenerator: ({ xAxis, width, height, offset }: import("recharts/types/util/types").ChartCoordinate) => number[];
        horizontalCoordinatesGenerator: ({ yAxis, width, height, offset }: import("recharts/types/util/types").ChartCoordinate) => number[];
        ...
        renderAxis(axisOptions: import("recharts/types/util/types").BaseAxisProps, element: any, displayName: string, index: number): import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
        ...
        getSnapshotBeforeUpdate?(prevProps: Readonly<import("recharts/types/chart/generateCategoricalChart").CategoricalChartProps>, prevState: Readonly<import("recharts/types/chart/generateCategoricalChart").CategoricalChartState>): any;
