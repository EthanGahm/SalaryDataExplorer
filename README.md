...
We are using the MERN Stack to build our project. The backend portion of the project is located on this repo , click [here](https://github.com/EthanGahm/SalaryDataExplorerBackend)
